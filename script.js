...
const account3 = {
  owner: "Ajayi Halleluyah Oluwaseyi",
  movements: [200, 455, 306, 25000, 8320, -133.0, 2000, 1300],
  interestRate: 1.3, // %
  pin: 2304,
...
//   const b = now.getMinutes();
//   const c = now.getSeconds();

//   console.log(`The time is ${a}:${b}:${c}`);
// }, 3500);
